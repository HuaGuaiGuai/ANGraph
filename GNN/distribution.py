...
def main():
    ...
    parser.add_argument('--num_layer', type=int, default=20,
    ...
    parser.add_argument('--dataset', type=str, default="latency_dense_noc_encoder_3",
                        help='dataset name')
    ...
    save_dir = "{}/{}/{}/pooling_{}/layer{}/{}/".format(args.save_dir, args.dataset, args.gnn, args.graph_pooling, args.num_layer,datetime.datetime.now().strftime("%Y_%m_%d_%H_%M"))
    ...
    dicts = {
        ...
        "best_validation_score": "{}.".format(valid_curve[best_val_epoch]),
        "best_test_score":"{}.".format(test_curve[best_val_epoch]),
    }
